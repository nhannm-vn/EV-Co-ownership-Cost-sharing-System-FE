    ...
    <div className='relative w-full h-screen flex items-center justify-center p-6'>
      ...
      <div className='absolute inset-0 -z-10 overflow-hidden'>
        ...
        <motion.div
          ...
          className='absolute -top-20 -left-20 w-96 h-96 rounded-full 
                     bg-gradient-to-tr from-violet-500/20 to-purple-700/20 blur-3xl'
        />
        ...
        <motion.div
          ...
          className='absolute bottom-0 right-0 w-[32rem] h-[32rem] rounded-full 
                     bg-gradient-to-tr from-indigo-500/20 to-slate-700/20 blur-3xl'
        />
      </div>
      ...
      <motion.div
        ...
        className='relative w-full max-w-5xl rounded-3xl bg-white/5 backdrop-blur-lg 
                   border border-violet-500/30 shadow-[0_0_40px_rgba(139,92,246,0.25)] 
      ...
      >
        ...
        <div className='w-full md:w-1/2 text-center md:text-left'>
          ...
          <div className='mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start'>
            ...
            <Link
              to={path.dashBoard}
              className='px-6 py-3 rounded-full border border-white/20 text-white/90 
