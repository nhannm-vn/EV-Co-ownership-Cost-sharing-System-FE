  ...
  return (
    <tbody>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div className='font-bold text-white'>{state.newGroup.groupName}</div>
        ...
        >
          {state.newGroup.description.length > 50 ? (
            <Tooltip title={state.newGroup.description} placement='topLeft'>
              <span
                /*
            ...
            /* text-slate-300: màu chữ xám sáng */
            <span className='text-slate-300'>{state.newGroup.description}</span>
          )}
        </td>
      </tr>
    </tbody>
