  ...
  return (
    <div className='min-h-screen bg-gray-50 p-8'>
      {contracts.map((contract) => (
        <>
          {/* admin group gửi feedback hay member feedback admin group duyệt sẽ cho hệ thống xử lí  */}
          {contract?.approvalStatus === 'SIGNED' || contract?.approvalStatus === 'PENDING' ? (
                ...
                <table className='min-w-full divide-y divide-gray-200'>
                  <thead className='bg-gray-100'>
                    <tr>
                      ...
                      <th className=' text-start px-6 text-xs font-medium text-gray-700 uppercase tracking-wider'>
                        Actions
                      </th>
                    </tr>
                  </thead>
